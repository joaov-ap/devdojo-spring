...
class AnimeServiceTest {
    ...
    @Test
    @DisplayName("findAllPaginated returns a list of animes")
    @Order(1)
    void findAllPaginated_ReturnPaginatedAnimes_WhenSuccessful() {
        ...
        var animes = service.findAllPaginated(pageRequest);
        Assertions.assertThat(animes).isNotNull().hasSameElementsAs(animeList);
    }
